...
const Doctors = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto py-6 animate-fade-in px-4">
            ...
            {/* ส่วนหัวของหน้า */}
            <div className="bg-gradient-to-r from-blue-700 to-blue-500 rounded-3xl p-8 md:p-12 text-white shadow-lg mb-8 relative overflow-hidden">
                ...
                <p className="text-blue-500 text-lg max-w-2xl font-light text-blue-50">
            ...
            {loading ? (
                <div className="flex flex-col items-center justify-center py-20 text-gray-400">
                    ...
                    <p className="font-medium">กำลังโหลดข้อมูลทีมแพทย์...</p>
                </div>
            ) : (
                filteredDoctors.length > 0 ? (
                                    ...
                                    <div>
                                        <div className="flex items-center gap-5 mb-6">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-blue-600 font-medium flex items-center gap-1.5 mt-1 text-sm">
                                        ...
                                        <div className="bg-slate-50 rounded-2xl p-4 mb-6 space-y-3 border border-gray-100">
                                            <div className="flex items-center justify-between text-sm">
                                                <span className="text-gray-500 flex items-center gap-2">
                                                    <Award size={16} className="text-blue-400" /> แผนก
                                                </span>
                                                <span className="font-semibold text-gray-700">{doc.departmentName || 'ไม่ระบุแผนก'}</span>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div className="text-center py-20 bg-white rounded-3xl border border-gray-100 shadow-sm">
                        ...
                        <h3 className="text-xl font-bold text-gray-500">ไม่พบรายชื่อแพทย์ในแผนกที่เลือก</h3>
                        <button 
